...
class PlayerOne extends React.Component {
  ...
  character = {
    img:
      "https://res.cloudinary.com/snackmanproductions/image/upload/v1573332068/react-game/Idle_3_ynny6z.png",
    width: 47,
    height: 102,
    coords: {
      top: 500,
    ...
    if (!e.repeat) {
      ...
      if (this.state.lazerCount <= max) {
        this.setState(prevState => ({
          ...
          characterPositionX:
            prevState.characterPositionX + spriteSheet / spriteColumns
        }));
      }
      ...
      if (this.state.jumpInterval <= max / 2) {
        this.setState(prevState => {
          return {
            ...
            characterPositionY:
              prevState.characterPositionY + spriteSheet / spriteColumns
          };
        });
      }
      if (this.state.jumpInterval >= max / 2) {
  ...
  movePlayer = (e, player, canvas) => {
    ...
    if (typeof e === "object" && e.keyCode === 68) {
      //go right
      this.props.getPlayerDimensions(
        this.playerOneRef.current.getBoundingClientRect()
      );
      ...
      this.setState(prevState => ({
        ...
        characterPositionX: (prevState.characterPositionX +=
          spriteSheet / spriteColumns),
        windowPosX: this.props.player.playerDimensions.x
      }));
      console.log(this.state.windowPosX);
